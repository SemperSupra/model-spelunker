#!/usr/bin/env python3
"""Gate 7: direct vs fixed-crop vs bounded-active evidence on the Gate-6 slice."""
...
def main() -> int:
    ...
    with TemporaryDirectory(prefix="openimages-gate7-") as tmpdir:
        root = Path(tmpdir)
    ...
    result = {
        "schema_version": "openimages_treatment_gate7.v0.1",
        "status": "pass",
