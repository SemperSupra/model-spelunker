#!/usr/bin/env python3
"""Bounded RTLCoder specialist adapter.

The authority-bearing controller may call generate_verilog(spec).  This module
talks only to a local Ollama endpoint and returns candidate RTL text; it does
not write files, execute commands, run tests, or access the network.
"""
